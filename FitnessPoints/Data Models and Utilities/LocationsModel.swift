...
class LocationsModel {
    ...
    func canWeWorkout(latitude: Double, longitude: Double) -> Bool {
        ...
        var places:[Places] = [
            ...
            Places( title: "Alec",
                    cllocation: CLLocation( latitude :36.6157, longitude: -121.8285), regionRadius: 50.0, location: "Alec",
            ...
            Places( title: "Paul",
                    cllocation: CLLocation(latitude:36.6651,longitude:-121.8039), regionRadius:50.0, location:"Paul",
            ...
            Places( title: "StarbucksMarina",
                    cllocation: CLLocation(latitude:36.6658,longitude:-121.8099), regionRadius:50.0, location:"StarbucksMarina",
            ...
            Places( title: "StarbucksSalinas",
                    cllocation: CLLocation(latitude:36.6706,longitude:-121.6414), regionRadius:50.0, location:"StarbucksSalinas",
            ...
            Places( title: "Courthouse",
                    cllocation: CLLocation(latitude:36.6748,longitude:-121.6585), regionRadius:50.0, location:"Courhouse",
            ...
            Places( title: "Skyler",
                    cllocation: CLLocation(latitude:36.6161,longitude:-121.8361), regionRadius:50.0, location:"Skyler",
            ...
            Places( title: "CSUMB",
                    cllocation: CLLocation(latitude:36.6545,longitude:-121.8084), regionRadius:50.0, location:"CSUMB",
            ...
            Places( title: "Anytime Fitness Marina",
                    cllocation: CLLocation(latitude:36.6654,longitude:-121.8109), regionRadius:50.0, location:"Anytime Fitness Marina",
            ...
            Places( title: "In Shape Seaside",
                    cllocation: CLLocation(latitude:36.5968,longitude:-121.8537), regionRadius:50.0, location:"In Shape Seaside",
            ...
            Places( title: "Crossfit Monterey",
                    cllocation: CLLocation(latitude:36.6015,longitude:-121.8653), regionRadius:50.0, location:"Crossfit Monterey",
            ...
            Places( title: "First City Crossfit",
                    cllocation: CLLocation(latitude:36.5851,longitude:-121.8504), regionRadius:50.0, location:"First City Crossfit",
            ...
            Places( title: "Starbucks Sand City",
                    cllocation: CLLocation(latitude:36.6223,longitude:-121.8442), regionRadius:50.0, location:"Starbucks Sand City",
            ...
            Places( title: "MaxFit - Monterey",
                    cllocation: CLLocation(latitude:36.5949,longitude:-121.8904), regionRadius:50.0, location:"MaxFit - Monterey",
